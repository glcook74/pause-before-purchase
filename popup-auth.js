/**
 * Dopamine Delay — Popup Auth UI
 * Handles Supabase sign-in, sign-up link, local-only mode, and sign-out.
 * Loaded before popup.js so auth state is resolved before dashboard renders.
 */
