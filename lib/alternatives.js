...
const DDAlternatives = (() => {
  ...
  const LIBRARY = [
    ...
    },
    {
      id: 'gratitude',
      icon: '🙏',
      label: "Name 3 things you're grateful for",
      category: 'GRATITUDE',
      action: 'inline',
      detail: "Pause and think of three things you're genuinely grateful for right now. Gratitude activates reward circuits without spending a penny."
    },
    {
      id: 'hydration',
      icon: '💧',
      ...
      category: 'HYDRATION',
      action: 'inline',
      detail: 'Get up and drink a full glass of water. Dehydration mimics fatigue and craving — your brain might just be thirsty.'
    }
  ];
  ...
  return { getAlternatives, getFullLibrary, LIBRARY };
})();
